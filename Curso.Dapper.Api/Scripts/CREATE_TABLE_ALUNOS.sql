...
VALUES('João', 'jose@email.com', '1990-01-01', 1, '2020-01-01')
...
-- Path: Curso.Dapper.Exemplo.Api\Scripts\INSERT_ALUNOS.sql
INSERT INTO Alunos(Nome, Email, DataNascimento, Ativo, DataCriacao)
VALUES('José', 'jose@email.com', '1990-01-01', 1, '2020-01-01')
...
VALUES('Analise Desenvolvimento de Sistemas', 'Descrição 1', 'Coordenador 1', 'Professor 1', '2020-01-01')

-- Path: Curso.Dapper.Exemplo.Api\Scripts\INSERT_CURSOS.sql
INSERT INTO Cursos(Nome, Descricao, Coordenador, Professor, DataCriacao)
VALUES('Ciências da Computação', 'Descrição 2', 'Coordenador 2', 'Professor 2', '2020-01-01')

-- Path: Curso.Dapper.Exemplo.Api\Scripts\INSERT_CURSOS.sql
INSERT INTO Cursos(Nome, Descricao, Coordenador, Professor, DataCriacao)
VALUES('Engenharia da Computação', 'Descrição 3', 'Coordenador 3', 'Professor 3', '2020-01-01')

-- Path: Curso.Dapper.Exemplo.Api\Scripts\INSERT_CURSOS.sql
INSERT INTO Cursos(Nome, Descricao, Coordenador, Professor, DataCriacao)
VALUES('Sistemas de Informação', 'Descrição 4', 'Coordenador 4', 'Professor 4', '2020-01-01')
...
INSERT INTO Turmas(Nome, NomeCurso, DataCriacao, IdCurso, IdTurno)
VALUES('Turma 2', 'Ciências da Computação', '2020-01-01', 2, 2)

INSERT INTO Turmas(Nome, NomeCurso, DataCriacao, IdCurso, IdTurno)
VALUES('Turma 3', 'Engenharia da Computação', '2020-01-01', 3, 3)

INSERT INTO Turmas(Nome, NomeCurso, DataCriacao, IdCurso, IdTurno)
VALUES('Turma 4', 'Sistemas de Informação', '2020-01-01', 4, 4)
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE dbo.ObterTurnos
AS
BEGIN
	SET NOCOUNT ON;
	SELECT * FROM Turnos;
...
--PROC USANDO TABELA TIPO COMO PARAMETRO
...
ALTER TABLE Cursos
ADD TipoCurso VARCHAR(50)

ALTER TABLE Cursos
ADD TemaTcc VARCHAR(200)