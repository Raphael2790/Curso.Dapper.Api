...
public class TurmasController : ControllerBase
{
    ...
    {
        using var connection = new SqlConnection(_connectionString);
        var sql = @"SELECT t.Id, t.Nome, t.NomeCurso, t.DataCriacao, t.IdCurso, t.IdTurno,
                           tu.Id, tu.Nome, tu.DataCriacao
                    FROM Turmas t
    ...
    [HttpGet("turmas-turnos-multiple-select", Name = "BuscarTodasTurmasETurnos")]
